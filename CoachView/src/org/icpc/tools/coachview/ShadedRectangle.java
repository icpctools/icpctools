...
public class ShadedRectangle {
	...
	public static void drawRoundRect(Graphics2D g, int x, int y, int w, int h, IContest contest, IResult result,
			long time, String s) {
		Paint paint = getPaint(h, result.getStatus(), ContestUtil.isRecent(contest, result), result.isFirstToSolve(), time);
		Color outline = null;
	...
	public static void drawRoundRect(Graphics2D g, int x, int y, int w, int h, IContest contest, ISubmission submission, long time,
			String s) {
	...
	private static void drawRoundRect(Graphics2D g, int x, int y, int w, int h, Paint paint, Color outline, String s) {
