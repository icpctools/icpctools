...
public class ResolverOptimizer {
	...
	public static void main(String[] args) {
		...
		// args[0] = "/Users/deboer/ICPC/2018/cdp/event-feed.json";
		ContestSource contestSource = Resolver.parseSource(args);
		...
		System.out.println("Resolution time: " + time + "ms");
		System.out.println("Time/option: " + time / (dps.size() + 1) + "ms");

		ro.findBestPath();

		// System.out.println("Total time: " + time + "ms");
		// System.out.println("Time/tree: " + time / (dps.size() + 1) + "ms");
	}
	...
	protected void findBestPath() {
		...
		System.out.println("Best path: " + best[0].weight);
		// for (PathStep ps : best)
		// System.out.println(" " + ps);
		output(best);

		best = findBestPath(null, root, false);
		System.out.println("Worst path: " + best[0].weight);
		// for (PathStep ps : best)
		// System.out.println(" " + ps);
		output(best);
	}
	...
	protected void output(PathStep[] list) {
		for (PathStep step : list) {
			if (step.dp != null)
				System.out.print(step.dp.teamId);
			System.out.print("\t");
