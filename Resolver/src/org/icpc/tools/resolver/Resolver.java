...
public class Resolver {
	...
	protected static void showHelp() {
		...
		System.out.println();
		System.out.println("  Resolving options:");
		...
		System.out.println("         displays logos, suitable for a lower resolution/side display");
		System.out.println("         when used with a CDS in distributed mode");
		System.out.println("     --team");
		System.out.println("         displays minimal content, e.g. to display on all team machines");
		System.out.println("         when used with a CDS in distributed mode");
		System.out.println();
