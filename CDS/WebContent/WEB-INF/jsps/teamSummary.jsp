                    ...
                    <table class="table table-sm table-hover table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td <% if (r.isFirstToSolve()) { %> class="text-right bg-success"
                                    <% } else if (r.getStatus() == Status.SOLVED) { %> class="text-right table-success"
                                    <% } else if (r.getStatus() == Status.FAILED) { %> class="text-right table-danger"
                                    <% } else if (r.getStatus() == Status.SUBMITTED) { %>
                                    class="text-right table-warning" <% } %>>
                                    <% if (r.getNumSubmissions() > 0) { %><%= r.getNumSubmissions() + " / " + time %><% } %>
                                </td>
                                <% } %>
