...
public class FloorGeneratorNAC24 extends FloorGenerator {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            floor.createAisle(x, y + 2 * taw, x, y - taw * 7);
            ...
            x = createAisleOfTeams(27, x, y, 6);

            floor.createAisle(x, y + taw, x, y - taw * 6);

            x = createAisleOfTeams(39, x, y, 6);
...
//            // add spares next to 1 and 12
            ITeam t = createAdjacentTeam(floor, 1, -1, 0, taw);
            floor.makeSpare(t);
            t = createAdjacentTeam(floor, 12, -2, 0, taw);
            floor.makeSpare(t);
